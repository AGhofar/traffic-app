...
<div class="content-wrapper">
    ...
    <div class="content">
        <div class="container-fluid ">
            <div class="card">
                <form action="{{ url('/simpang5/data-simpang/simpan') }}" autocomplete="off" method="POST">
                    @csrf
                    <div class="card-body row">
                        ...
                        <div class="form-group col-sm-12 col-md-6 col-xl-6">
                            ...
                            <input type="text" class="form-control" id="jalan_barat_laut" name="jalan_barat_laut" placeholder="Nama Jalan ..." required>
                        </div>
                        <div class="form-group col-12">

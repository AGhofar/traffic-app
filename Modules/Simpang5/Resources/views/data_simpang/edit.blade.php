...
<div class="content-wrapper">
    ...
    <div class="content">
        <div class="container-fluid ">
            <div class="card">
                <form action="{{ url('/simpang5/data-simpang/update',$id) }}" autocomplete="off" method="POST">
                    @csrf
                    <div class="card-body row">
                        ...
                        <div class="form-group col-sm-12 col-md-6 col-xl-6">
                            ...
                            <input type="text" class="form-control" id="jalan_barat" name="jalan_barat" placeholder="Nama Jalan ..." value="{{ $data_simpang->jalan_barat }}" required>
                        </div>
                        <div class="form-group col-sm-12 col-md-6 col-xl-6">
                            <label for="jalan_barat_laut">Lengan Barat Laut</label>
                            <input type="text" class="form-control" id="jalan_barat_laut" name="jalan_barat_laut" placeholder="Nama Jalan ..." value="{{ $data_simpang->jalan_barat_laut }}" required>
                        </div>
                        <div class="form-group col-12">
                        ...
                        <div class="col-12 row mt-3">
                            <div class="col-sm-12 col-md-6 col-xl-6">
                                <a href="{{ url('/simpang5/data-simpang') }}" class="btn btn-default btn-block">Batal</a>
                            </div>
                            <div class="col-sm-12 col-md-6 col-xl-6">

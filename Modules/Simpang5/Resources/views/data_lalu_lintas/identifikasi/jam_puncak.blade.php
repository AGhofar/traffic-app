                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover text-center">
                            ...
                            <tbody>
                                <tr>
                                    <th rowspan="6" class="align-middle">Pagi<br>06:00 - 10:00<br><small>(durasi 4 Jam)</small></th>
                                    <td>{{ $data_simpang['jalan_utara'] }}</td>
                                    <td rowspan="5" class="align-middle">{{ $data_pagi_jam_puncak['jam_puncak'] }}</td>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $data_pagi_jam_puncak['total_mc_barat_laut'] }}</td>
                                    <td>{{ $data_pagi_jam_puncak['total_lv_barat_laut'] }}</td>
                                    <td>{{ $data_pagi_jam_puncak['total_hv_barat_laut'] }}</td>
                                    <td>{{ $data_pagi_jam_puncak['total_barat_laut'] }}</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <th rowspan="6" class="align-middle">Siang<br>10:00 - 14:00<br><small>(durasi 4 Jam)</small></th>
                                    <td>{{ $data_simpang['jalan_utara'] }}</td>
                                    <td rowspan="5" class="align-middle">{{ $data_siang_jam_puncak['jam_puncak'] }}</td>
                                ...
                                <tr>
                                    <td>{{ $data_simpang['jalan_barat_laut'] }}</td>
                                    <td>{{ $data_siang_jam_puncak['total_mc_barat_laut'] }}</td>
                                    <td>{{ $data_siang_jam_puncak['total_lv_barat_laut'] }}</td>
                                    <td>{{ $data_siang_jam_puncak['total_hv_barat_laut'] }}</td>
                                    <td>{{ $data_siang_jam_puncak['total_barat_laut'] }}</td>
                                </tr>
                                <tr>
                                    <th colspan="5">Total</th>
                                ...
                                <tr>
                                    <th rowspan="6" class="align-middle">Sore<br>14:00 - 18:00<br><small>(durasi 4 Jam)</small></th>
                                    <td>{{ $data_simpang['jalan_utara'] }}</td>
                                    <td rowspan="5" class="align-middle">{{ $data_sore_jam_puncak['jam_puncak'] }}</td>
                                ...
                                <tr>
                                    <td>{{ $data_simpang['jalan_barat_laut'] }}</td>
                                    <td>{{ $data_sore_jam_puncak['total_mc_barat_laut'] }}</td>
                                    <td>{{ $data_sore_jam_puncak['total_lv_barat_laut'] }}</td>
                                    <td>{{ $data_sore_jam_puncak['total_hv_barat_laut'] }}</td>
                                    <td>{{ $data_sore_jam_puncak['total_barat_laut'] }}</td>
                                </tr>
                                <tr>
                                    <th colspan="5">Total</th>
                                ...
                                <tr>
                                    <th rowspan="6" class="align-middle">Malam<br>18:00 - 06:00<br><small>(durasi 12 Jam)</small></th>
                                    <td>{{ $data_simpang['jalan_utara'] }}</td>
                                    <td rowspan="5" class="align-middle">{{ $data_malam_jam_puncak['jam_puncak'] }}</td>
                                ...
                                <tr>
                                    <td>{{ $data_simpang['jalan_barat_laut'] }}</td>
                                    <td>{{ $data_malam_jam_puncak['total_mc_barat_laut'] }}</td>
                                    <td>{{ $data_malam_jam_puncak['total_lv_barat_laut'] }}</td>
                                    <td>{{ $data_malam_jam_puncak['total_hv_barat_laut'] }}</td>
                                    <td>{{ $data_malam_jam_puncak['total_barat_laut'] }}</td>
                                </tr>
                                <tr>
                                    <th colspan="5">Total</th>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover text-center">
                            ...
                            <tbody>
                                <tr>
                                    <td rowspan="4" class="align-middle">Utara</td>
                                    <td rowspan="4" class="align-middle">{{$data_simpang['jalan_utara']}}</td>
                                    <td>LT/LTOR</td>
                                ...
                                <tr>
                                    <td>RT1</td>
                                    <td>{{ $pendekat['utara_RT1_lv'] }}</td>
                                    <td>{{ $pendekat['utara_RT1_hv'] }}</td>
                                    <td>{{ $pendekat['utara_RT1_mc'] }}</td>
                                    <td>{{ $pendekat['utara_RT1_um'] }}</td>
                                    <td>{{ $pendekat['utara_RT1'] }}</td>
                                </tr>
                                <tr>
                                    <td>RT2</td>
                                    <td>{{ $pendekat['utara_RT2_lv'] }}</td>
                                    <td>{{ $pendekat['utara_RT2_hv'] }}</td>
                                    <td>{{ $pendekat['utara_RT2_mc'] }}</td>
                                    <td>{{ $pendekat['utara_RT2_um'] }}</td>
                                    <td>{{ $pendekat['utara_RT2'] }}</td>
                                </tr>
                                <tr>
                                    <td rowspan="4" class="align-middle">Selatan</td>
                                    <td rowspan="4" class="align-middle">{{$data_simpang['jalan_selatan']}}</td>
                                    <td>LT/LTOR</td>
                                ...
                                <tr>
                                    <td>ST1</td>
                                    <td>{{ $pendekat['selatan_ST1_lv'] }}</td>
                                    <td>{{ $pendekat['selatan_ST1_hv'] }}</td>
                                    <td>{{ $pendekat['selatan_ST1_mc'] }}</td>
                                    <td>{{ $pendekat['selatan_ST1_um'] }}</td>
                                    <td>{{ $pendekat['selatan_ST1'] }}</td>
                                </tr>
                                <tr>
                                    <td>ST2</td>
                                    <td>{{ $pendekat['selatan_ST2_lv'] }}</td>
                                    <td>{{ $pendekat['selatan_ST2_hv'] }}</td>
                                    <td>{{ $pendekat['selatan_ST2_mc'] }}</td>
                                    <td>{{ $pendekat['selatan_ST2_um'] }}</td>
                                    <td>{{ $pendekat['selatan_ST2'] }}</td>
                                </tr>
                                <tr>
                                    <td>RT</td>
                                ...
                                <tr>
                                    <td rowspan="4" class="align-middle">Timur</td>
                                    <td rowspan="4" class="align-middle">{{$data_simpang['jalan_timur']}}</td>
                                    <td>LT/LTOR</td>
                                ...
                                <tr>
                                    <td>ST1</td>
                                    <td>{{ $pendekat['timur_ST1_lv'] }}</td>
                                    <td>{{ $pendekat['timur_ST1_hv'] }}</td>
                                    <td>{{ $pendekat['timur_ST1_mc'] }}</td>
                                    <td>{{ $pendekat['timur_ST1_um'] }}</td>
                                    <td>{{ $pendekat['timur_ST1'] }}</td>
                                </tr>
                                <tr>
                                    <td>ST2</td>
                                    <td>{{ $pendekat['timur_ST2_lv'] }}</td>
                                    <td>{{ $pendekat['timur_ST2_hv'] }}</td>
                                    <td>{{ $pendekat['timur_ST2_mc'] }}</td>
                                    <td>{{ $pendekat['timur_ST2_um'] }}</td>
                                    <td>{{ $pendekat['timur_ST2'] }}</td>
                                </tr>
                                <tr>
                                    <td>RT</td>
                                ...
                                <tr>
                                    <td rowspan="4" class="align-middle">Barat</td>
                                    <td rowspan="4" class="align-middle">{{$data_simpang['jalan_barat']}}</td>
                                    <td>LT1</td>
                                    <td>{{ $pendekat['barat_LT1_lv'] }}</td>
                                    <td>{{ $pendekat['barat_LT1_hv'] }}</td>
                                    <td>{{ $pendekat['barat_LT1_mc'] }}</td>
                                    <td>{{ $pendekat['barat_LT1_um'] }}</td>
                                    <td>{{ $pendekat['barat_LT1'] }}</td>
                                </tr>
                                <tr>
                                    <td>LT2</td>
                                    <td>{{ $pendekat['barat_LT2_lv'] }}</td>
                                    <td>{{ $pendekat['barat_LT2_hv'] }}</td>
                                    <td>{{ $pendekat['barat_LT2_mc'] }}</td>
                                    <td>{{ $pendekat['barat_LT2_um'] }}</td>
                                    <td>{{ $pendekat['barat_LT2'] }}</td>
                                </tr>
                                <tr>
                                    <td>ST</td>
                                ...
                                <tr>
                                    <td rowspan="4" class="align-middle">Barat</td>
                                    <td rowspan="4" class="align-middle">{{$data_simpang['jalan_barat_laut']}}</td>
                                    <td>LT/LTOR</td>
                                    <td>{{ $pendekat['barat_laut_LT_lv'] }}</td>
                                    <td>{{ $pendekat['barat_laut_LT_hv'] }}</td>
                                    <td>{{ $pendekat['barat_laut_LT_mc'] }}</td>
                                    <td>{{ $pendekat['barat_laut_LT_um'] }}</td>
                                    <td>{{ $pendekat['barat_laut_LT'] }}</td>
                                </tr>
                                <tr>
                                    <td>ST1</td>
                                    <td>{{ $pendekat['barat_laut_ST1_lv'] }}</td>
                                    <td>{{ $pendekat['barat_laut_ST1_hv'] }}</td>
                                    <td>{{ $pendekat['barat_laut_ST1_mc'] }}</td>
                                    <td>{{ $pendekat['barat_laut_ST1_um'] }}</td>
                                    <td>{{ $pendekat['barat_laut_ST1'] }}</td>
                                </tr>
                                <tr>
                                    <td>ST2</td>
                                    <td>{{ $pendekat['barat_laut_ST2_lv'] }}</td>
                                    <td>{{ $pendekat['barat_laut_ST2_hv'] }}</td>
                                    <td>{{ $pendekat['barat_laut_ST2_mc'] }}</td>
                                    <td>{{ $pendekat['barat_laut_ST2_um'] }}</td>
                                    <td>{{ $pendekat['barat_laut_ST2'] }}</td>
                                </tr>
                                <tr>
                                    <td>RT</td>
                                    <td>{{ $pendekat['barat_laut_RT_lv'] }}</td>
                                    <td>{{ $pendekat['barat_laut_RT_hv'] }}</td>
                                    <td>{{ $pendekat['barat_laut_RT_mc'] }}</td>
                                    <td>{{ $pendekat['barat_laut_RT_um'] }}</td>
                                    <td>{{ $pendekat['barat_laut_RT'] }}</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>

...
use Modules\Simpang4\Http\Controllers\DataLaluLintasController;
use Modules\Simpang4\Http\Controllers\FormatDataController;
use Modules\Simpang4\Http\Controllers\IdentifikasiController;
use Modules\Simpang4\Http\Controllers\Simpang4Controller;

Route::prefix('simpang4')->group(function () {
    Route::get('/', [Simpang4Controller::class, 'index']);
    Route::prefix('/data-simpang')->group(function () {
        Route::get('/', [Simpang4Controller::class, 'index']);
        Route::get('/tambah', [Simpang4Controller::class, 'create']);
        Route::post('/simpan', [Simpang4Controller::class, 'store']);
        Route::get('/show/{id}', [Simpang4Controller::class, 'show']);
        Route::get('/edit/{id}', [Simpang4Controller::class, 'edit']);
        Route::post('/update/{id}', [Simpang4Controller::class, 'update']);
        Route::get('/hapus/{id}', [Simpang4Controller::class, 'destroy']);
    });

                    ...
                    <table class="table table-bordered table-hover text-center">
                        <thead class="table-bordered">
                            <tr>
                                ...
                                <th colspan="12">{{ $data_simpang['jalan_utara'] }}</th>
                                <th colspan="12">{{ $data_simpang['jalan_timur'] }}</th>
                                <th colspan="12">{{ $data_simpang['jalan_selatan'] }}</th>
                                <th colspan="12">{{ $data_simpang['jalan_barat'] }}</th>
                            </tr>
                            <tr>
                                <th colspan="4">RT</th>
                                <th colspan="4">ST</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>@isset($utara_RTs[$index]['mc']) {{$utara_RTs[$index]['mc']}} @endisset</td>
                                <td>@isset($utara_RTs[$index]['lv']) {{$utara_RTs[$index]['lv']}} @endisset</td>
                                <td>@isset($utara_RTs[$index]['hv']) {{$utara_RTs[$index]['hv']}} @endisset</td>
                                <td>@isset($utara_RTs[$index]['um']) {{$utara_RTs[$index]['um']}} @endisset</td>
                                ...
                                <td>@isset($timur_STs[$index]['mc']) {{$timur_STs[$index]['mc']}} @endisset</td>
                                <td>@isset($timur_STs[$index]['lv']) {{$timur_STs[$index]['lv']}} @endisset</td>
                                <td>@isset($timur_STs[$index]['hv']) {{$timur_STs[$index]['hv']}} @endisset</td>
                                <td>@isset($timur_STs[$index]['um']) {{$timur_STs[$index]['um']}} @endisset</td>
                                ...
                                <td>@isset($barat_LTs[$index]['mc']) {{$barat_LTs[$index]['mc']}} @endisset</td>
                                <td>@isset($barat_LTs[$index]['lv']) {{$barat_LTs[$index]['lv']}} @endisset</td>
                                <td>@isset($barat_LTs[$index]['hv']) {{$barat_LTs[$index]['hv']}} @endisset</td>
                                <td>@isset($barat_LTs[$index]['um']) {{$barat_LTs[$index]['um']}} @endisset</td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>

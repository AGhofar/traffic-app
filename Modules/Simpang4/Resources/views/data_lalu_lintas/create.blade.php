...
<div class="content-wrapper">
            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ url('/simpang4/data-lalu-lintas') }}">Identifikasi</a></li>
    ...
    <div class="content">
        <div class="container-fluid ">
            <div class="card">
                <div class="card-body">
                    <form class="row" action="{{ url('/simpang4/data-lalu-lintas/preview') }}" autocomplete="off" name="preview" id="preview" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="col-12 row mt-3">
                            <div class="col-sm-12 col-md-6 col-xl-6">
                                <a href="{{ url('/simpang4/data-lalu-lintas') }}" class="btn btn-default btn-block">Batal</a>
                            </div>
                            <div class="col-sm-12 col-md-6 col-xl-6">
            ...
            <div class="card" id="preview_card">
                <div class="card-body">
                    <form class="row" action="{{ url('/simpang4/data-lalu-lintas/simpan') }}" autocomplete="off" name="simpan" id="simpan" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered text-center" id="table_preview">
                                <thead class="table-bordered">
                                    <tr>
                                        <th rowspan="3"></th>
                                        <th colspan="39">LENGAN UTARA</th>
                                        <th colspan="39">LENGAN TIMUR</th>
                                        <th colspan="39">LENGAN SELATAN</th>
                                        <th colspan="39">LENGAN BARAT</th>
                                    </tr>
                                    <tr>
                                        <th colspan="39">Nama Jalan Utara</th>
                                        <th colspan="39">Nama Jalan Timur</th>
                                        <th colspan="39">Nama Jalan Selatan</th>
                                        <th colspan="39">Nama Jalan Barat</th>
                                    </tr>
                                    <tr>
...
<script>
    ...
    $(document).ready(function() {
        $('#preview').on('submit', function(event) {
            ...
            $.ajax({
                url: "{{ url('/simpang4/data-lalu-lintas/preview') }}",
                method: 'POST',

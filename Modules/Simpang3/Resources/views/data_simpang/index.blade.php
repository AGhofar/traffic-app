        ...
        <div class="container-fluid">
            <div class="row mb-2">
                ...
                <div class="col-sm-6 d-flex justify-content-end align-items-center">
                    <a href="{{ url('simpang3/data-simpang/tambah') }}" class="btn btn-primary btn-lg"><i class="fa fa-plus"></i>&nbsp;&nbsp;Tambah Data</a>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    </section>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ url('simpang3/data-simpang/edit',$data_simpang->id) }}" type="button" class="btn btn-warning btn-sm">Edit</a>
                                    <a onclick="return confirm('Are you sure?')" href="{{ url('simpang3/data-simpang/hapus',$data_simpang->id) }}" type="button" class="btn btn-danger btn-sm">Hapus</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
